...
\begin{frame}{Open Source}
  ...
  \begin{columns}[c]
    \begin{column}{0.50\textwidth}
      \centering
      \qrcode[height=5cm]{https://github.com/NauelSerraino/XBRL2Vec}
    \end{column}
    \begin{column}{0.45\textwidth}
      \centering
      {\Huge \faGithub}\\[1em]
      \textbf{\large github.com/NauelSerraino/XBRL2Vec}\\[1.5em]
      \small
      \begin{itemize}
        \item Full training pipeline
        \item XBRL data processing
        \item Attribution analysis notebooks
      \end{itemize}
    \end{column}
  \end{columns}
